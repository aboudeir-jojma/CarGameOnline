...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-white shadow-lg mt-auto mt-20">
            ...
            {footerLinks.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className="group flex items-center gap-2 hover:text-yellow-300 transition-colors"
                >
            ...
            {socialLinks.map((item) => {
              ...
              return (
                <a
                  ...
                  className="group p-2 rounded-lg hover:bg-yellow-800 transition-colors"
