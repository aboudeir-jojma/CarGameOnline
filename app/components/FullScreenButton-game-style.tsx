...
export default function FullScreenButton() {
  ...
  return (
    <button
      ...
      className="absolute top-4 right-4 z-50 bg-white/10 hover:bg-white/20 text-white p-2 rounded-full shadow-lg transition-all duration-200 hover:scale-105 backdrop-blur-sm border border-white/20 hover:border-white/30"
