...
export default function FullScreenButton() {
  ...
  return (
    <button
      ...
      className="absolute top-6 right-6 z-50 bg-black hover:bg-gray-800 text-white p-3 rounded-lg shadow-lg transition-all duration-200 hover:scale-105 border border-gray-600"
