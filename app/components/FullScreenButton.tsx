...
export default function FullScreenButton() {
  ...
  return (
    <button
     ...
     className="absolute top-2 right-4 lg:right-[300px] z-50 bg-black/80 hover:bg-black/90 text-white p-2 rounded-lg shadow-lg transition-all duration-200 hover:scale-105 backdrop-blur-sm border border-gray-700"
