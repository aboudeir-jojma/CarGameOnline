...
export default function FullScreenButton() {
  ...
  return (
    <button
      ...
      className="fixed top-6 right-8 z-50 bg-black/80 hover:bg-black/90 text-white p-3 rounded-lg shadow-lg transition-all duration-200 hover:scale-105 backdrop-blur-sm border border-gray-700"
